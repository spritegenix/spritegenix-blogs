                                    ...
                                    <?php if (!empty($latestPosts)): ?>
                                        <?php foreach ($latestPosts as $latestPost): ?>
                                            <div class="post">
                                                ...
                                                <?php endif; ?>
                                                <h5 class="text"><a href="<?= base_url('blog/' . esc($latestPost['slug'])) ?>"><?= esc(substr($latestPost['title'], 0, 45)) ?><?= strlen($latestPost['title']) > 50 ? '...' : '' ?></a></h5>
                                            </div>
                                        <?php endforeach; ?>
                                    <?php else: ?>
                                    ...
                                    <ul>
                                        <?php if (!empty($categories)): ?>
                                            <?php foreach ($categories as $category): ?>
                                                <li><a href="<?= base_url('category/' . esc($category['slug'])) ?>"><?= esc($category['category_name']) ?></a></li>
                                            <?php endforeach; ?>
                                        <?php else: ?>
